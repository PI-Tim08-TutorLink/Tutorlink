...
namespace TutorLinkApp.Services.Implementations
{
    public class AdminService : IAdminService
    {
        ...
        public async Task<int> GetTotalUsers()
            => await _context.Users.CountAsync(u => u.DeletedAt == null);

        public async Task<int> GetTotalTutors()
            => await _context.Tutors.CountAsync(t => t.DeletedAt == null);

        public async Task<int> GetTotalStudents()
            => await _context.Users.CountAsync(u => u.RoleId == 2 && u.DeletedAt == null);
